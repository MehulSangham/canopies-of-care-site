          ...
          {(footnoteIds.length > 0 || onAddFootnote) && (
            <>
              ...
              <div className="relative" ref={fnRef}>
                ...
                {showFnCreate && (
                  <div className="absolute left-0 top-full mt-1 z-50 w-[300px] border border-[color:var(--color-nis-ink)] bg-[color:var(--color-nis-white)] shadow-[4px_4px_0_0_var(--color-nis-accent)]">
